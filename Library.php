...
<nav class="navbar-bottom" aria-label="Page navigation">
  <ul class="pager">
    <li class="previous"><?php echo "<a href='library.php?";
		echo 'offset=', intval($offset) - 10;
		echo "'>Previous page</a>"
		?>
	</li>
    <li>
	<input onClick="form.action='Delete_book.php'" class="btn btn-danger navbar-btn" id="Delete" type="submit" value='Delete'/>
	</li>
	<a type="button" class="btn btn-info navbar-btn" href="add-book.html" id="New" >Add a new book</a>
	
	<li class="next"><?php echo "<a href='library.php?";
		echo 'offset=', intval($offset) + 10;
		echo "'>Next page</a>"
		?>
	</li>
